...
| support_evidence_mapping | root/support_protocol_1 | gpt-5.6-terra | medium | FRESH_SPAWN | parts/support_protocol_pp001_032.md |
| support_evidence_mapping | root/support_protocol_2 | gpt-5.6-terra | medium | FRESH_SPAWN | parts/support_protocol_pp033_063.md |
| support_evidence_mapping | root/support_admin_sap | gpt-5.6-terra | medium | FRESH_SPAWN | parts/support_admin_sap.md |
| support_evidence_mapping | root/support_results_supp | gpt-5.6-terra | medium | FRESH_SPAWN | parts/support_results_supp.md |
| mapping_consolidation | root/mapping_consolidator | gpt-5.6-terra | medium | FRESH_SPAWN | relationships/numeric_relationship_inventory.md |
