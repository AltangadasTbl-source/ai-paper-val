...
| numeric_consistency_reviewer | root/numeric_checks | gpt-5.6-terra | medium | FRESH_SPAWN | checkers/numeric_consistency.md |
| cross_source_consistency_reviewer | root/cross_source_checks | gpt-5.6-terra | medium | FRESH_SPAWN | checkers/cross_source_consistency.md |
