...
- **Finished UTC:** COORDINATOR_FINAL_FINISHED_UTC
- **Observed elapsed minutes:** COORDINATOR_FINAL_OBSERVED_ELAPSED_MINUTES
- **Target status:** COORDINATOR_FINAL_TARGET_STATUS
- **Exceedance causes:** COORDINATOR_FINAL_EXCEEDANCE_CAUSES

### Token accounting

- **Token accounting status:** COORDINATOR_FINAL_TOKEN_ACCOUNTING_STATUS
- **Total-token count status:** COORDINATOR_FINAL_TOTAL_TOKEN_COUNT_STATUS
- **Total tokens:** COORDINATOR_FINAL_TOTAL_TOKENS
- **Known token cost (USD):** COORDINATOR_FINAL_KNOWN_TOKEN_COST_USD
- **Estimated complete token cost (USD):** COORDINATOR_FINAL_ESTIMATED_COMPLETE_TOKEN_COST_USD
...
|---|---:|---:|---:|---:|---:|---:|---:|
| COORDINATOR_FINAL_PER_MODEL_TABLE | __ | __ | __ | __ | __ | __ | __ |
