# Workflow 1.5.1 Artifact and Report Specification

## Canonical artifacts

Write new artifacts only below `.ai_paper_validation/review_1_5_1/`, except for the two versioned
...
- converted Office PDF inside this run: `[derived.pdf — PDF p. 3](<review_1_5_1/preprocessing/converted_pdf/derived.pdf#page=3>)`;
