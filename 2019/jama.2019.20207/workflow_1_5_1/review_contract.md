# Workflow 1.5.1 Review Contract
...
but not read as scientific inputs or candidate sources in workflow 1.5.1.
...
pdfinfo "source.pdf"
pdftotext -f N -l N "source.pdf" ".ai_paper_validation/review_1_5_1/preprocessing/native-N.txt"
pdftotext -layout -f N -l N "source.pdf" ".ai_paper_validation/review_1_5_1/preprocessing/layout-N.txt"
pdftoppm -f N -l N -singlefile -png "source.pdf" ".ai_paper_validation/review_1_5_1/preprocessing/page-N"
tesseract ".ai_paper_validation/review_1_5_1/preprocessing/page-N.png" ".ai_paper_validation/review_1_5_1/preprocessing/ocr-N" -l eng --psm 6
libreoffice --headless --convert-to pdf --outdir ".ai_paper_validation/review_1_5_1/preprocessing/converted_pdf" "support.docx"
python3 workflow_1_5_1/scripts/extract_office_source.py "support.xlsx" ".ai_paper_validation/review_1_5_1/preprocessing/office_structure/support"
```
