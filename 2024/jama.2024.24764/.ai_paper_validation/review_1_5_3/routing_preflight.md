...
- Checked UTC: 2026-08-19T05:20:02Z

| Named preset | Required model | Required effort | Verified |
|---|---|---|---|
...
The project configuration fixes the current coordinator to `gpt-5.6-sol` at `high` effort. All nine bundled named presets were read directly and match the fixed Workflow 1.5.3 routing contract. Provider credentials remain outside the package configuration.
