# Workflow 1.5.3 Agent Execution Manifest
...
| evidence_rechecker_append_C008 | root/evidence_rechecker_c008 | gpt-5.6-sol | high | FRESH_SPAWN | verification/evidence_recheck_append_C008.md |
