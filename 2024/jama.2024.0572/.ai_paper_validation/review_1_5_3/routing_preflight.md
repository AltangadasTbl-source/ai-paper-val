...
- Checked UTC: 2026-08-19T04:31:45Z
...
The project configuration pins the current coordinator and each of the nine named presets to the fixed model/effort matrix. Provider credentials remain outside the package configuration. No moving model alias is used.
