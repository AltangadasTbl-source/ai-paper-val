...
The runtime presented specialist IDs with a leading slash (for example, `/root/statistics_pass_1`). Rows use the validator-safe canonical form with that single leading slash removed; the remainder is unchanged.
