# Patch 1.2.1 artifact and report specification
...
```text
.ai_paper_validation/
├── final_report_1_2_1.md
├── final_report_1_2_1.html
└── patch_1_2_1/
...
3. Package Manifest.
4. AI Training Restriction Summary, carried forward separately when legacy records contain it.
5. Recovery Scope, Source Coverage, and Known Legacy Gaps.
6. Human Review Queue Index (at most 10).
7. Candidate Evidence Cards, exactly matching the queue.
8. Deferred-Ledger Summary with counts and a link to `patch_1_2_1/recovered_candidate_ledger.md`.
9. Limitations and Missing Evidence.
10. Human Adjudication Checklist.
11. Reproducibility and Source-Integrity Metadata.
