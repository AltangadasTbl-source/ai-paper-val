# OpenRouter and Direct Codex Setup for Workflow 1.5.4

Workflow 1.5.4 uses the same fixed model allocation as workflows 1.5.1 and 1.5.2:
...
```text
Read START_PROMPT.md completely and execute Workflow 1.5.4 now.
```
...
`routing_preflight.md`, and successfully start the required fresh source preprocessor. If the
