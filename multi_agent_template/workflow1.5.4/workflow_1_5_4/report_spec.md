# Workflow 1.5.4 Artifact and Report Specification

## Canonical artifacts

Write new artifacts only below `.ai_paper_validation/review_1_5_4/`, except for the two versioned
...
```markdown
- **Token accounting status:** COMPLETE, INCOMPLETE_PRICE_UNAVAILABLE, INCOMPLETE_BILLING_BREAKDOWN, or INCOMPLETE_RUNTIME_USAGE_UNAVAILABLE
...
- freshly derived PDF: `[derived.pdf — PDF p. 3](<review_1_5_4/preprocessing/converted_pdf/derived.pdf#page=3>)` and name its source Office file;
