# Workflow 1.5.4 Review Contract
...
Use a package-relative plain path and a stable unit type. Workflow 1.5.4 requires zero reusable units,
...
Write all new derivatives below `.ai_paper_validation/review_1_5_4/preprocessing/`. Never modify a
...
pdfinfo "source.pdf"
pdftotext "source.pdf" ".ai_paper_validation/review_1_5_4/preprocessing/native_text/source.txt"
pdftotext -layout "source.pdf" ".ai_paper_validation/review_1_5_4/preprocessing/layout_text/source.txt"
pdftoppm -f N -l N -singlefile -png "source.pdf" ".ai_paper_validation/review_1_5_4/preprocessing/rendered_pages/source-N"
tesseract ".ai_paper_validation/review_1_5_4/preprocessing/rendered_pages/source-N.png" ".ai_paper_validation/review_1_5_4/preprocessing/ocr_text/source-N" -l eng --psm 6
libreoffice --headless --convert-to pdf --outdir ".ai_paper_validation/review_1_5_4/preprocessing/converted_pdf" "support.docx"
python3 workflow_1_5_4/scripts/extract_office_source.py "support.xlsx" ".ai_paper_validation/review_1_5_4/preprocessing/office_structure/support"
```
...
| fresh_source_preprocessor | RUNTIME-ID-PREPROCESSOR | ~openai/gpt-latest | medium | FRESH_SPAWN | source_inventory.md |
