...
agent_contracts=(
  "qc15-reuse-asset-curator.toml|high"
...
review_dir="$package_root/.ai_paper_validation/review_1_5_3"
...
probe_log="$(mktemp -t workflow-1-5-3-openrouter-probe.XXXXXX)"
probe_dir="$(mktemp -d -t workflow-1-5-3-openrouter-probe-dir.XXXXXX)"
