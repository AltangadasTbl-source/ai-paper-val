# Workflow 1.4.2 Artifact and Report Specification

## Canonical artifacts

Write new artifacts only below `.ai_paper_validation/review_1_4_2/`, except for the two versioned
...
- freshly derived PDF: `[derived.pdf — PDF p. 3](<review_1_4_2/preprocessing/converted_pdf/derived.pdf#page=3>)` and name its source Office file;
