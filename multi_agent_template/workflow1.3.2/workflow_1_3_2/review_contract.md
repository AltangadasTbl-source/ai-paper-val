# Workflow 1.3.2 Review Contract
...
Write all new derivatives below `.ai_paper_validation/review_1_3_2/preprocessing/`. Never modify a
...
pdfinfo "source.pdf"
pdftotext "source.pdf" ".ai_paper_validation/review_1_3_2/preprocessing/native_text/source.txt"
pdftotext -layout "source.pdf" ".ai_paper_validation/review_1_3_2/preprocessing/layout_text/source.txt"
pdftoppm -f N -l N -singlefile -png "source.pdf" ".ai_paper_validation/review_1_3_2/preprocessing/rendered_pages/source-N"
tesseract ".ai_paper_validation/review_1_3_2/preprocessing/rendered_pages/source-N.png" ".ai_paper_validation/review_1_3_2/preprocessing/ocr_text/source-N" -l eng --psm 6
libreoffice --headless --convert-to pdf --outdir ".ai_paper_validation/review_1_3_2/preprocessing/converted_pdf" "support.docx"
python3 workflow_1_3_2/scripts/extract_office_source.py "support.xlsx" ".ai_paper_validation/review_1_3_2/preprocessing/office_structure/support"
```
