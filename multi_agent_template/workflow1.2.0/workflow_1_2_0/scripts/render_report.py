#!/usr/bin/env python3
"""Render a workflow-1.2.0 report as standalone locally linked HTML5."""
...
def fallback_render(source: Path, destination: Path, title: str, css_path: Path) -> None:
    ...
    notice = (
        ...
        "workflow 1.2.0 preserves and mechanically rechecks candidates but does not assign "
...
def main() -> None:
    ...
    parser.add_argument(
        "--title", default="AI Paper Validation Report 1.2.0 — Pending Human Adjudication"
    )
